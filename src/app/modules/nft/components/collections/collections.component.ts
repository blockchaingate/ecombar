...
import { ABI as ERC1155ABI, Bytecode as ERC1155Bytecode} from '../../../../config/erc1155';
import { ABI as ERC721ABI, Bytecode as ERC721Bytecode} from '../../../../config/erc721';
  ...
  export class NftCollectionsComponent implements OnInit {
    ...
    async deployKanbanDo(seed, templateDone) {
      ...
      if(this.collection.type === 'ERC1155') {
        args = ['ERC1155','ERC1155','',environment.addresses.smartContract.ProxyRegistry];
        ABI = ERC1155ABI;
        Bytecode = ERC1155Bytecode;
      } else {
        args = ['ERC721','ERC721', environment.addresses.smartContract.ProxyRegistry];
        ABI = ERC721ABI;
